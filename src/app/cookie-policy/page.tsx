        ...
        <div className="bg-secondary py-16 md:py-20">
          <div className="container-custom">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold text-white">Cookie Policy</h1>
            </div>
              ...
              <div className="space-y-12">
                ...
                <section>
                  ...
                  <p className="text-gray-700 mb-4">
                    This Cookie Policy explains how W. Giertsen Energy Solutions ("we", "us", or "our") uses cookies and similar technologies to recognize you when you visit our website at <Link href="/" className="text-primary hover:underline">www.giertsen-energy.com</Link> ("Website"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
                  </p>
                  <p className="text-gray-700 mb-4">
