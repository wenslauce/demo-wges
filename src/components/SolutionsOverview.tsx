...
import { ArrowRight, Zap, Building, Home, CheckSquare, WrenchIcon, ArrowUpRight } from "lucide-react";
...
const SolutionsOverview = () => {
  ...
  const solutions = [
    ...
    {
      imageSrc: "/images/expert-opinion.avif",
      title: "Case Studies",
      href: "/solutions/case-studies",
      description: "Real-world examples of how our solutions have transformed energy consumption for our clients. See verified results and success stories from our diverse portfolio.",
    ...
    },
    {
      ...
      description: "Expert solar maintenance services provided by our team of 200+ certified engineers and energy auditors. Maximize your investment with our comprehensive monitoring, maintenance, and optimization services.",
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-gray-700 max-w-3xl mx-auto text-lg">
            Energy is essential for your company's success – it powers your machines,
            maintains comfortable temperatures, and illuminates your workplaces. Choose to
            profitably generate it yourself, buy dynamically, and store intelligently.
          </p>
