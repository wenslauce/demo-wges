...
const services = [
  ...
  { 
    ...
    description: "Custom solar solutions for homes with smart energy management.",
    icon: <HomeIcon className="w-4 h-4 text-primary-green" />
  },
  { 
    title: "Commercial Solutions",
    href: "/solutions/commercial-solutions",
    description: "Scalable energy systems for businesses to reduce costs and emissions.",
  ...
  { 
    ...
    description: "Professional services to ensure optimal system performance.",
...
const aboutSubmenu = [
  ...
  },
  {
    title: "Career",
    href: "/career",
    description: "Join our team and help shape the future of energy."
  }
];
...
const Header = () => {
  ...
  return (
    <motion.header 
      className={cn(
        "w-full fixed top-8 left-0 z-50 transition-all duration-500 px-4",
        isScrolled 
          ? "py-2" 
          : "py-3"
      )}
    ...
    >
      <div className="container mx-auto max-w-7xl relative">
        ...
        <motion.div 
          className={cn(
            "absolute inset-0 rounded-2xl backdrop-blur-xl transition-all duration-500 overflow-hidden",
            isScrolled 
        ...
        <div className="relative flex items-center justify-between py-3 px-6">
          ...
          >
            <Link href="/" className="transition-opacity hover:opacity-90">
              <Image src="/images/logo.png" alt="W. Giertsen Energy Solutions" width={180} height={60} priority className="drop-shadow-lg" />
            </Link>
          </motion.div>
            ...
            <NavigationMenu>
              <NavigationMenuList>
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-2 p-4 md:w-[600px] md:grid-cols-2 rounded-xl overflow-hidden">
                        ...
                        >
                          <NavigationMenuLink asChild>
                            <Link
                              href={service.href}
                              className={cn(
                                "group relative block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors",
                            ...
                            >
                              {/* Enhanced solution card with icon and animations */}
                              <div className="flex items-start gap-3">
                                <div className="mt-0.5 p-1 rounded-md bg-white/10 group-hover:bg-white/20 transition-colors">
                                  {service.icon}
                                </div>
                                <div>
                                  <div className="text-sm font-medium leading-none text-white group-hover:text-primary-green transition-colors duration-150">
                                    {service.title}
                                  </div>
                                  <motion.p 
                                    className="line-clamp-2 mt-1 text-xs text-white/60 group-hover:text-white/80"
                                    initial={{ opacity: 0 }}
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-2 p-4 rounded-xl overflow-hidden">
                          ...
                          <NavigationMenuLink asChild>
                            ...
                            >
                              ...
                              <motion.p 
                                className="line-clamp-2 mt-1 text-xs text-white/60 group-hover:text-white/80"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: hoveredIndex === index + 100 ? 1 : 0.7 }}
                                transition={{ duration: 0.2 }}
                              >
                                {item.description}
                              </motion.p>
